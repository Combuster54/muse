...
#include <iit_commons/rbd/StateDependentMatrix.h>
 ...
 */
class JSIMBase : public iit::rbd::StateDependentMatrix<iit_commons::dog::JointState, 18, 18, JSIMBase>
{
public:
...
public:
    virtual const JSIMBase& update(const iit_commons::dog::JointState&) = 0;
