...
struct LegOdometry_
{
  ...
  : header(_init)
  {
    ...
    {
      std::fill<typename std::array<double, 3>::iterator, double>(this->lin_vel_lf.begin(), this->lin_vel_lf.end(), 0.0);
      std::fill<typename std::array<double, 3>::iterator, double>(this->lin_vel_rf.begin(), this->lin_vel_rf.end(), 0.0);
      std::fill<typename std::array<double, 3>::iterator, double>(this->lin_vel_lh.begin(), this->lin_vel_lh.end(), 0.0);
      std::fill<typename std::array<double, 3>::iterator, double>(this->lin_vel_rh.begin(), this->lin_vel_rh.end(), 0.0);
      std::fill<typename std::array<double, 3>::iterator, double>(this->base_velocity.begin(), this->base_velocity.end(), 0.0);
    }
  }
