...
static const _ResumeEstimator_Request_type_support_symbol_names_t _ResumeEstimator_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, srv, ResumeEstimator_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, state_estimator_msgs, srv, ResumeEstimator_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, state_estimator_msgs, srv, ResumeEstimator_Request)() {
  return &::state_estimator_msgs::srv::rosidl_typesupport_c::ResumeEstimator_Request_message_type_support_handle;
}
...
static const _ResumeEstimator_Response_type_support_symbol_names_t _ResumeEstimator_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, srv, ResumeEstimator_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, state_estimator_msgs, srv, ResumeEstimator_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, state_estimator_msgs, srv, ResumeEstimator_Response)() {
  return &::state_estimator_msgs::srv::rosidl_typesupport_c::ResumeEstimator_Response_message_type_support_handle;
}
...
static const _ResumeEstimator_type_support_symbol_names_t _ResumeEstimator_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, srv, ResumeEstimator)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, state_estimator_msgs, srv, ResumeEstimator)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, state_estimator_msgs, srv, ResumeEstimator)() {
  return &::state_estimator_msgs::srv::rosidl_typesupport_c::ResumeEstimator_service_type_support_handle;
}
