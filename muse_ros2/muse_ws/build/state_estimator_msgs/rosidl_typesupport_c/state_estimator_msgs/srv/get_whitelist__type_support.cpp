...
static const _GetWhitelist_Request_type_support_symbol_names_t _GetWhitelist_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, srv, GetWhitelist_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, state_estimator_msgs, srv, GetWhitelist_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, state_estimator_msgs, srv, GetWhitelist_Request)() {
  return &::state_estimator_msgs::srv::rosidl_typesupport_c::GetWhitelist_Request_message_type_support_handle;
}
...
static const _GetWhitelist_Response_type_support_symbol_names_t _GetWhitelist_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, srv, GetWhitelist_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, state_estimator_msgs, srv, GetWhitelist_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, state_estimator_msgs, srv, GetWhitelist_Response)() {
  return &::state_estimator_msgs::srv::rosidl_typesupport_c::GetWhitelist_Response_message_type_support_handle;
}
...
static const _GetWhitelist_type_support_symbol_names_t _GetWhitelist_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, srv, GetWhitelist)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, state_estimator_msgs, srv, GetWhitelist)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, state_estimator_msgs, srv, GetWhitelist)() {
  return &::state_estimator_msgs::srv::rosidl_typesupport_c::GetWhitelist_service_type_support_handle;
}
