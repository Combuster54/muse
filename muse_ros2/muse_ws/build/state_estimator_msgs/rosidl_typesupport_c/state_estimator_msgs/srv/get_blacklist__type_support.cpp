...
static const _GetBlacklist_Request_type_support_symbol_names_t _GetBlacklist_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, srv, GetBlacklist_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, state_estimator_msgs, srv, GetBlacklist_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, state_estimator_msgs, srv, GetBlacklist_Request)() {
  return &::state_estimator_msgs::srv::rosidl_typesupport_c::GetBlacklist_Request_message_type_support_handle;
}
...
static const _GetBlacklist_Response_type_support_symbol_names_t _GetBlacklist_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, srv, GetBlacklist_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, state_estimator_msgs, srv, GetBlacklist_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, state_estimator_msgs, srv, GetBlacklist_Response)() {
  return &::state_estimator_msgs::srv::rosidl_typesupport_c::GetBlacklist_Response_message_type_support_handle;
}
...
static const _GetBlacklist_type_support_symbol_names_t _GetBlacklist_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, state_estimator_msgs, srv, GetBlacklist)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, state_estimator_msgs, srv, GetBlacklist)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, state_estimator_msgs, srv, GetBlacklist)() {
  return &::state_estimator_msgs::srv::rosidl_typesupport_c::GetBlacklist_service_type_support_handle;
}
